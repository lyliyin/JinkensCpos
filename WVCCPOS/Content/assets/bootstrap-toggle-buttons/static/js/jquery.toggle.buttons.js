          ...
          , methods = {
              init: function (opt) {
                  this.each(function () {
                      ...
                      //if ($element.children("i:eq(0)").html() != undefined) {
                      //    first = $element.children("i:eq(0)").html();
                      //}
                      //var second = "";

                      //if ($element.children("i:eq(1)").html() != undefined) {
                      //    second = $element.children("i:eq(1)").html();
                      //}

                      //alert("first" + first + ": " + second);
